...
<span style="color:rgb(216, 203, 251)">Running DML operations may read inconsistent data in a data lake</span> if another job is writing at the same time. To perform an update or delete in a traditional data lake, we would typically need to:
